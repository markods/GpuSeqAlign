...
static void print_cmd_usage(std::ostream& os)
{
    os << "nw --algParamPath \"path\" --seqPath \"path\" [params]\n"
          ...
          "                           In that case, the algorithm is run first. If not specified, defaults to the first\n"
          "                           algorithm in the \"algParam\" JSON file.\n"
          ...
          "                           written to, once per alignment. Defaults to \"./logs/%{datetime}_debug.txt\" if\n"
